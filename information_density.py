...
sensor_cosine_density = information_density(coordinates,'cosine')
sensor_euclidian_density = information_density(coordinates,'euclidean')
...
with plt.style.context('ggplot'):
    ...
    plt.colorbar()
    plt.subplot(1, 2, 2)
    plt.scatter(avg_year_PM25['Longitude'], avg_year_PM25['Latitude'], c=sensor_euclidian_density, cmap='viridis', s=50)
    plt.title('The euclidean information density')
    plt.colorbar()
    plt.show()
...
with plt.style.context('ggplot'):
    ...
    ax.scatter(avg_year_PM25['Longitude'], avg_year_PM25['Latitude'], c=sensor_euclidian_density, cmap='viridis', s=50)
